...
folder_path = r"C:\Users\Christoph\Documents\Master Thesis\Frametimes"
output_folder_path = r'C:\Users\Christoph\Documents\Master Thesis\Frametimes\Finished_Files'
...
for file in selected_files:
    ...
    df = pd.read_excel(file_path, usecols="A:B")  # Adjust 'usecols' as needed
    dfs.append(df)
...
name = output_name[0:2] + output_name[7:-1]
name_xlsx = "Merged_Frametimes" + "_".join(name) + ".xlsx"
