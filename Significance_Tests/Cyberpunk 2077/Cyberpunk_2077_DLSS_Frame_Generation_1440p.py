...
# Game: Cyberpunk 2077
# T-Test: Native and DLSS (Frame Generation Results) at 1440p
...
native_fps = np.array([66, 53, 44])
dlss_performance_fps = np.array([132, 114, 99])
dlss_balanced_fps = np.array([120, 112, 93])
dlss_quality_fps = np.array([109, 98, 85])
